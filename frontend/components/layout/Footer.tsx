      ...
      <div className="bg-blue-600 py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-2xl sm:text-3xl font-bold mb-3">Stay Updated with Latest News</h3>
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                <input
                  ...
                  required
                  className="flex-1 px-4 sm:px-6 py-3 sm:py-4 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-white text-sm sm:text-base"
                />
                <button
                  type="submit"
                  className="px-6 sm:px-8 py-3 sm:py-4 bg-white text-blue-600 font-semibold rounded-lg hover:bg-gray-100 transition-colors text-sm sm:text-base whitespace-nowrap"
                >
                  Subscribe Now
                </button>
              </form>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="text-center sm:text-left">
            <Link href="/" className="inline-flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">Khabri</span>
            </Link>
            <p className="text-gray-400 text-sm mt-4">
              Your trusted source for breaking news and in-depth journalism from India and around the world.
            </p>
            <div className="flex justify-center sm:justify-start space-x-4 mt-6">
              ...
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition" aria-label="YouTube">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Quick Links */}
          <div className="text-center sm:text-left">
            <h5 className="font-semibold mb-4 text-base sm:text-lg">Categories</h5>
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li>
                <Link href="/category/entertainment" className="hover:text-white transition">
                  Entertainment
                </Link>
              </li>
            </ul>
          ...
          {/* Company */}
          <div className="text-center sm:text-left">
            <h5 className="font-semibold mb-4 text-base sm:text-lg">Company</h5>
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>
          ...
          {/* Legal */}
          <div className="text-center sm:text-left">
            <h5 className="font-semibold mb-4 text-base sm:text-lg">Legal</h5>
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>
              ...
              <li>
                <Link href="/ethics-policy" className="hover:text-white transition">
                  Ethics Policy
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-6 sm:pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-xs sm:text-sm text-center sm:text-left">
              &copy; 2025 Khabri News. All rights reserved. | Delivering Truth, Building Trust.
            </p>
